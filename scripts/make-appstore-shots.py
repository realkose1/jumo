...
# 화면별 문구: (제목 2줄, 부제)
CAPTIONS = {
    '1-home.png':     (['해외 한국 선수,', '오늘 경기 한눈에'],   '골 · 도움 · 평점까지 결과로 바로'),
    '2-lineup.png':   (['실제 포메이션으로', '보는 라인업'],       '선발 · 벤치 · 경기 평점'),
    '3-schedule.png': (['지난 결과부터', '다음 경기까지'],        '진행 중인 경기는 위에서 강조'),
    '4-team.png':     (['소속팀 일정과', '순위까지'],             '팀 상세 · 스쿼드 · 리그 순위'),
    '5-players.png':  (['내 선수만 골라', '시즌 기록 비교'],       '골 · 도움 · 경기 · 평점'),
    '6-notif.png':    (['출전하는 날만', '알림으로'],             '라인업 · 킥오프 · 골 · 경기 종료'),
}
